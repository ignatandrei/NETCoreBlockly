...
namespace TestNetCorePackage.Controllers
{
    ...
    public class DepartmentsController : ControllerBase
    {
        ...
        // GET: api/Departments
        [HttpGet]
        public async Task<ActionResult<IEnumerable<DBDepartment>>> GetDepartment()
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<DBDepartment>> GetDepartment(long id)
        {
        ...
        [HttpDelete("{id}")]
        public async Task<ActionResult<DBDepartment>> DeleteDepartment(long id)
        {
